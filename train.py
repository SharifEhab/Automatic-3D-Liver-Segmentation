...
from utilities import train, calculate_pixels, calculate_weights
import wandb
"""
...
Data preparation is done in the DataPreperation.ipynb file. The data is prepared by converting the DICOM files to NIfTI files and splitting the data into training and testing sets.
"""
